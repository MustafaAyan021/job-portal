...
const DeleteJob = async () => {
    try {
        const confrim = window.confirm("Are you shure you want to delete this Job ?")
        if (confrim) {
...
<template>
    <section>
        <div class="container m-auto py-6 px-6">
            <RouterLink to="/jobs"
                class="bg-green-600 hover:bg-green-700 items-center w-44 p-3 rounded-lg shadow-md text-white"> Back To
                Job Listing
            </RouterLink>
        </div>
    </section>
